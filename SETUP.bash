# @file SETUP.bash
# @brief Source this file to add the Cluster Utils tools to your PATH in place.
#
...
echo "ClusterUtils, NRC-CNRC, (c) 2005 - 2021, Her Majesty in Right of Canada" >&2
...
echo "ClusterUtils path: $BASE_DIR" >&2
